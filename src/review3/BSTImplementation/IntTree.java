...
public class IntTree {
	...
	/*
	 * The method prints the data fields of the tree using an inorder traversal
	 */
	public void inOrder() {
		IntTreeNode.clearCycleData();
	...
	/*
	 * The method prints in inorder the data fields of the tree with given root
	 */
	private void inOrder(IntTreeNode root) {
		if (root != null) {
			inOrder(root.__gotoLeft());
			System.out.print(" " + root.data);
			inOrder(root.__gotoRight());
		}
	}


	// TODO 1: Complete the method body for reverseInOrder. 
	//         You may add additional methods as needed

	/*
	 * The method prints all the integers stored in the tree in the reverse of the in-order
	 */
	public void reverseInOrder() {
		System.out.println("reverseInOrder to be implemented");
	}


	// TODO 2: Complete the method body for preOrder. 
	//         You may add additional methods as needed

	/*
	 * The method prints the data fields of the tree using a preorder traversal
	 */
	public void preOrder() {
		System.out.println("preOrder to be implemented");
	}

	// TODO 3: Complete the method body for postOrder. 
	//         You may add additional methods as needed

	/* 
	 * The method prints the data fields of the tree using a postorder traversal
	 */
	public void postOrder() {
		System.out.println("postOrder to be implemented");
	}
	...
	// TODO 4: Complete the method body for sumNodes. You may add additional method as needed.
	/*
	 * The method returns the sum of the values of all the integers stored in the tree.
	 */
	public int sumNodes()
	{
		return 0;
	...
	// TODO 5: Complete the method body for countLeftNodes. You may use additional methods
	/*
	 * The method returns the number of left children in the tree. A left child is a node
	 * that appears as the root of the left-hand subtree of another node.  
